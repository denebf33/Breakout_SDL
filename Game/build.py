...
if platform.system()=="Linux":
    ...
    INCLUDE_DIR="-I./include/ -I./lib/SDL2.framework/Headers -I./lib/SDL2_ttf.framewirk/Headers -I./lib/SDL2_mixer.framework/Headers -I./lib/SDL2_image.framework/Headers"
    LIBRARIES="-F./lib -framework SDL2 -framework SDL2_ttf -framework SDL2_mixer -framework SDL2_image"
